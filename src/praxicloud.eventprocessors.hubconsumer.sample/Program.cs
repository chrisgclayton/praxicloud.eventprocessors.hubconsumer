...
namespace praxicloud.eventprocessors.hubconsumer.sample
{
    ...
    class Program
    {
        ...
        private static async Task MainAsync()
        {
            ...
            var processor = new FixedBatchProcessorClient<BatchProcessor>(logger, metricFactory, ConnectionStringPartition, "$default", processorOptions, leaseManager, checkpointManager);
